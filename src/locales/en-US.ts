export default {
  ...
  sidebar: {
    ...
    // MSG-3528: user-created projects are renameable / removable
    projectRename: 'Rename project',
    projectRenamePrompt: 'Enter a new project name',
    projectTitleRequired: 'Project name cannot be empty',
    projectRemove: 'Delete project',
    projectRemoveConfirm: 'Delete project "{name}"? Its tasks are kept but unlinked.',
